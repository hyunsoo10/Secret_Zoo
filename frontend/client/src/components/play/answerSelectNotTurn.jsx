    ...
    <>
      <div className="overlay">
        <div className='text-white text-xl text-center'>
          <h2 style={{ fontSize: '1.5em' }} className='mb-4'> <strong className='text-lime-300'>{p1}</strong> 플레이어가 <strong className='text-lime-300'>{p2}</strong> 플레이어에게 말했습니다.</h2>
          <h1 style={{ fontSize: '2.5em' }}>이거 <strong className='text-teal-300'> {animal} </strong> (이)야.</h1> <br></br>
